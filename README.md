...
<pre><code>
In this task we have supermarket which contains customers, whenever customer decide to pay off, it will choose the smallest queue.
So that they can buy all goods ASAP
